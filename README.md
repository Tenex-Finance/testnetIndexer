...
This repo contains the indexer for [Tenex V2](https://Tenex.finance/) on Blast and [Aerodrome](https://aerodrome.finance/) on Base.
...
- `config.yaml`
  ...
  - Allows the same contract & event structure to be shared across two different chains (Blast  for Tenex V2 and Aerodrome respectively)
